 ...
 */
class CommentStartState implements com.itextpdf.styledxmlparser.css.parse.syntax.IParserState {
     ...
     */
    CommentStartState(com.itextpdf.styledxmlparser.css.parse.syntax.CssParserStateController controller) {
