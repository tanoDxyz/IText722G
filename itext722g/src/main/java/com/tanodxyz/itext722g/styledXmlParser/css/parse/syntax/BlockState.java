 ...
 */
class BlockState implements com.itextpdf.styledxmlparser.css.parse.syntax.IParserState {
     ...
     */
    BlockState(com.itextpdf.styledxmlparser.css.parse.syntax.CssParserStateController controller) {
